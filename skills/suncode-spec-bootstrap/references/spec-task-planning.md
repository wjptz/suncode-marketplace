...
Use a single agent as the default execution model. The agent may create Suncode tasks for traceability, but the skill should not require a specific platform, CLI, or parallel worker model.
...
When a Suncode task is useful, write a concise PRD with these sections:
