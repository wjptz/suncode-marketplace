...
| ------------------------------- | ------ | -------- |
| `.suncode/spec/mobile/index.md` | Create | Yes      |
| `.suncode/spec/mobile/*.md`     | Create | Yes      |
...
Create `.suncode/spec/mobile/index.md`:
...
def init_mobile_context(task_dir):
    ...
    with open(jsonl_path, "a") as f:
        f.write(json.dumps({
            "file": ".suncode/spec/mobile/index.md",
...
```jsonl
{"file": ".suncode/spec/mobile/index.md", "reason": "Mobile guidelines"}
{"file": ".suncode/spec/mobile/architecture.md", "reason": "Architecture patterns"}
```

---

## Step 5: Document in suncode-local
