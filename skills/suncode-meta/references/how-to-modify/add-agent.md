...
| `.suncode/tasks/{template}/my-agent.jsonl` | Create | Yes                   |
...
def init_my_agent_context(task_dir, dev_type):
    ...
    with open(jsonl_path, "w") as f:
        # Add relevant specs
        f.write(json.dumps({
            "file": ".suncode/spec/guides/index.md",
...
```jsonl
{"file": ".suncode/spec/guides/index.md", "reason": "Thinking guides"}
{"file": ".suncode/tasks/{task}/prd.md", "reason": "Requirements"}
```
