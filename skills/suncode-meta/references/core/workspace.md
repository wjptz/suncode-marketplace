...
- `.suncode/.developer` - Identity file
- `.suncode/workspace/<name>/` - Personal workspace
- `.suncode/workspace/<name>/index.md` - Personal index
- `.suncode/workspace/<name>/journal-1.md` - First journal
...
- Current task: `.suncode/tasks/01-31-add-login-taosu`
- Branch: feature/add-login
